...
class Particle {
  constructor(effect) {   // every particle will expect a reference pointing to the main effect object. We are not creating copies of the effect, 
    ...
    this.pushY = 0
    this.friction = 0.95 // force that works in the direction opposite to the direction in which the object is trying to move  and gradually slows the moving objet down
